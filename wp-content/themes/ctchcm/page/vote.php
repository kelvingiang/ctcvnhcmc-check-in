                            ...
                            <div id="lishiSpace" class="list_vote row">
                                <div class="col-lg-12" style="height:35px; background-color: #666; 
                                    ...
                                    <div class=" col-lg-1 col-md-1 col-sm-1 col-xs-1" 
                                        ...
                                        <input type="checkbox" style="width: 100%;" class="lishiAllcheck" name="lishiAllcheck"  id="lishiAllcheck"> 
                                    </div>
                                ...
                                foreach ($lishiList as $item) {
                                    ...
                                    <div class="list_item col-lg-12">
                                        <div class=" col-lg-1 col-md-1 col-sm-1 col-xs-1" style=" text-align: center; background-color:#f5f2f2 ">
                                            <input type="checkbox" style="width: 100%; cursor: pointer" class="lishi" name="<?php echo $item['ID'] ?>" id="<?php echo $item['ID'] ?>"> 
                                        </div>
                                        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-3">
                                            <?php echo $item['name'] ?>
                                        </div>
                        ...
                        <div class="col-lg-12">
                            <div id="jianshiSpace" class="list_vote row" >
                                <div class="col-lg-12" style="height:35px; background-color: #666; 
                                    ...
                                    <div class=" col-lg-1 col-md-1 col-sm-1 col-xs-1" 
                                         style=" height:  inherit;  border-right: 1px #fff solid; padding-top: 8px;">
                                        <input type="checkbox" style="width: 100%;" class="lishi"name="jianshiAllcheck"  id="jianshiAllcheck"> 
                                    </div>
                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-3" 
                                         style=" height:  inherit; border-right: 1px solid #fff; padding-top: 8px;">
                                        <label>姓名</label> 
                                ...
                                foreach ($jianshiList as $item) {
                                    ...
                                    <div class="list_item col-lg-12">
                                        <div class=" col-lg-1 col-md-1 col-sm-1 col-xs-1" style=" text-align: center; background-color:#f5f2f2 ">
                                            <input type="checkbox" style="width: 100%; cursor: pointer"" class="jianshi" name="<?php echo $item['ID'] ?>" id="<?php echo $item['ID'] ?>"> 
                                        </div>
                                        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-3">
                                            <?php echo $item['name'] ?>
                                        </div>
