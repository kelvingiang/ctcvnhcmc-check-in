...
<div id="check_setting">
    <div>
        <form name="f-title" id="f-title" method="get" >
            ...
            <input type="text" name="txt-title"  id="txt-title" value="<?php echo get_option('_vote_title') ?>" style="width: 80%; height: 32px" /> 
        </form>
    </div>
    ...
    <div>
        <a class="btn button button-primary button-large" 
           ...
           >理事總票設為 0 </a>
        <label style=" margin-left: 30px; font-weight: bold"> 理事總票數 ： <?php echo get_option('_vote_total_lishi') ?></label> 
    </div>
    <div>
        <a class="btn button button-primary button-large"
